...
?> 
<div class="wrap">   
<?php    echo "<h2>" . __( 'Top App Configuration', 'topapp_trdom' ) . "</h2>"; ?>  
...
<div class="inside">
  <table class="form-table">
       ...
       <tr>
       <th> <?php _e("Lien d'affiliation : " ); ?></th><td><input type="text" name="topapp_affi" id="topapp_affi" value="<?php echo $affi_config; ?>" size="20"> <br /><span class="description">Mettez votre lien d'affiliation sous la forme : http://clk.tradedoubler.com/click?p=23753&a=2076412&url=</span></td></tr>
       <tr> 
       <th><?php _e("Top à afficher : " ); ?></th><td><select name="topapp_cat"> <option>iPhone</option><option>iPad</option>   </select><br/> <span class="description">Sélection du Top à afficher : <strong><?php echo $cat_config;?></strong</span></td>  </tr>  
     <tr>
     <th><?php _e("Nous supporter : " ); ?></th><td><select name="topapp_soutien"><option>Oui</option><option>Non</option> </select>
     <br/> <span class="description"> Affiche un lien sous le widget : <strong><?php echo $soutien;?></strong</span></td></tr>

  </table>
        
         
        <p class="submit">  
        <input type="submit" name="Submit" value="<?php _e('Mettre à jour les options', 'topapp_trdom' ) ?>" />  
        </p>  
    </form>  
